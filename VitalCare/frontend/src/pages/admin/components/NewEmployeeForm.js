		...
		>
			<div className="flex flex-col h-full w-full justify-start items-center">
				...
				<div className="flex flex-col justify-center">
					...
					>
						<option value="funcionario">Secretário(a)</option>
				...
				<input
                 className="uppercase mt-[10px] text-sm font-bold py-3 px-5 shadow hover:bg-gray-700 hover:text-white rounded-2xl w-1/5 bg-gray-800 text-white"
                 type="submit"
                 value="CADASTRAR"
                 ></input>
